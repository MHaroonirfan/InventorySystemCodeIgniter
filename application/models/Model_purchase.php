...
class Model_purchase extends CI_Model
{
	...
	public function getPurchaseData($id = null)
	{
		...
		$sql = "SELECT * FROM purchase ORDER BY date_time ASC";
	...
	public function update($id)
	{
		if($id) {
			...
			$this->load->model('model_products');
			$get_purchase_item = $this->getPurchaseItemData($id);
			foreach ($get_purchase_item as $k => $v) {
	...
	{
		$sql = "SELECT * FROM purchase WHERE paid_status = ?";
