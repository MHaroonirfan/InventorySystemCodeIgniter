    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createOrder', $user_permission)): ?>
          <a href="<?php echo base_url('shoporders/create') ?>" class="btn btn-primary">Add Transfer Stock</a>
          <br /> <br />
        <?php endif; ?>

        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Manage Transfer Stock From Warehouse to Shop</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('shoporders/remove') ?>" method="post" id="removeForm">
...
$(document).ready(function() {
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + 'shoporders/fetchShopOrdersData',
    'order': []
  });
