          ...
          <form role="form" action="<?php base_url('products/update'); ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="date" class="form-control" name="date" value="<?php echo $product_data['date']; ?>" autocomplete="off" />
                </div>
                  <div class="form-group">
                  <label for="added_by">Added By</label>
                  <input type="text" class="form-control" name="added_by" autocomplete="off" value="<?php echo $user_data['firstname'] . ' ' . $user_data['lastname']; ?>" readonly />
