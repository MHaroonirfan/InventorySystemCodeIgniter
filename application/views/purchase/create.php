              ...
              <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="date" id="datePicker" class="col-sm-6" name="date" autocomplete="off" required>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6"></div>
                    <div class="form-group col-sm-6">
                        ...
                        <input type="time" class="col-sm-6" name="time" value="now" required>
                    </div>
                </div>
                  <?php // echo date('Y-m-d') ?>
                  ...
                  <div class="form-group">
                    ...
                    <option>Select</option>
                      <?php foreach ($suppliers as $k => $v): ?>
                        <option value="<?php echo $v['id'] ?>" address="<?php echo $v['address'] ?>" phone="<?php echo $v['phone'] ?>"><?php echo $v['name'] ?></option>
                      <?php endforeach ?>
                    </select>
                  </div>
                  <div class="form-group">
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-7">
                  <select class="form-control" id="order_status" name="purchase_status">
...
<script type="text/javascript">
  ...
  function removeRow(tr_id)
  {
    ...
    // get the supplier information from the server
