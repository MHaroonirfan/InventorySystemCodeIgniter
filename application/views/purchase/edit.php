                ...
                <?php echo validation_errors(); ?>
                  <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="date" class="col-sm-6" name="date" autocomplete="off" value="<?php echo $purchase_data['purchase']['date'] ?>" />
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6"></div>
                    <div class="form-group col-sm-6">
                        ...
                        <input type="time" class="col-sm-6" name="time" autocomplete="off" value="<?php echo $purchase_data['purchase']['time'] ?>" />
                    </div>
                </div>
<!--                <div class="form-group">
                ...
                <div class="col-md-4 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
                  <label for="customer_id" class="col-sm-5 control-label" style="text-align:left;">Supplier</label>
                  <div class="col-sm-7">
                    <select class="form-control select_group" id="supplier_id" name="supplier_id">
                      <?php foreach ($suppliers as $k => $v): ?>
                        <option value="<?php echo $v['id'] ?>" <?php if($purchase_data['purchase']['supplier_id'] == $v['id']) { echo "selected='selected'"; } ?> address="<?php echo $v['address'] ?>" phone="<?php echo $v['phone'] ?>" ><?php echo $v['name'] ?></option>
                      <?php endforeach ?>
                    </select>
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="supplier_address" name="supplier_address" placeholder="Enter Customer Address" value="<?php echo $supplier_detail['address'] ?>" autocomplete="off">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_phone" name="customer_phone" placeholder="Enter Customer Phone" value="<?php echo $supplier_detail['phone'] ?>" autocomplete="off">
                    </div>
                  </div>
                </div>
                      ...
                      <?php foreach ($purchase_data['purchase_item'] as $key => $val): ?>
                       ...
                       <tr id="row_<?php echo $x; ?>">
                         <td>
                          ...
                          <td>
                            <input type="text" name="rate[]" id="rate_<?php echo $x; ?>" class="form-control" value="<?php echo $val['rate'] ?>" autocomplete="off" onkeyup="getTotal(<?php echo $x; ?>)">
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="gross_amount" name="gross_amount" value="<?php echo $purchase_data['purchase']['gross_amount'] ?>" autocomplete="off">
                      <input type="hidden" class="form-control" id="gross_amount_value" name="gross_amount_value" value="<?php echo $purchase_data['purchase']['gross_amount'] ?>" autocomplete="off">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="service_charge" name="service_charge" value="<?php echo $purchase_data['purchase']['service_charge'] ?>" autocomplete="off">
                      <input type="hidden" class="form-control" id="service_charge_value" name="service_charge_value" value="<?php echo $purchase_data['purchase']['service_charge'] ?>" autocomplete="off">
                    </div>
                  </div>
                  <?php endif; ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="vat_charge" name="vat_charge" value="<?php echo $purchase_data['purchase']['vat_charge'] ?>" autocomplete="off">
                      <input type="hidden" class="form-control" id="vat_charge_value" name="vat_charge_value" value="<?php echo $purchase_data['purchase']['vat_charge'] ?>" autocomplete="off">
                    </div>
                  </div>
                  <?php endif; ?>
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="discount" name="discount" placeholder="Discount" onkeyup="subAmount()" value="<?php echo $purchase_data['purchase']['discount'] ?>" autocomplete="off">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="net_amount" class="col-sm-5 control-label">Net Amount</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="net_amount" name="net_amount" value="<?php echo $purchase_data['purchase']['net_amount'] ?>" autocomplete="off">
                  ...
                  <select class="form-control" id="payment_method" name="payment_method">
                    <option value="1" <?php if($purchase_data['purchase']['payment_method'] == 1) { echo "selected='selected'"; } ?>>Cash in hand</option>
                    <option value="2" <?php if($purchase_data['purchase']['payment_method'] == 2) { echo "selected='selected'"; } ?>>Bank Transfer</option>
                  </select>
                </div>
                 </div>
                 <div class="form-group">
                  ...
                  <select class="form-control" id="purchase_status" name="purchase_status">
                    <option value="1" <?php if($purchase_data['purchase']['purchase_status'] == 1) { echo "selected='selected'"; } ?>>Pending</option>
                    <option value="2" <?php if($purchase_data['purchase']['purchase_status'] == 2) { echo "selected='selected'"; } ?>>Debit</option>
                    <option value="3" <?php if($purchase_data['purchase']['purchase_status'] == 3) { echo "selected='selected'"; } ?>>Paid</option>
                  </select>
                </div>
                 </div>
              ...
              <div class="box-footer">
                ...
                <a target="__blank" href="<?php echo base_url() . 'purchase/printDiv/'.$purchase_data['purchase']['id'] ?>" class="btn btn-default" >Print</a>
...
<script type="text/javascript">
  ...
  $("#supplier_id").change(function() {
    $('#supplier_address').val($('option:selected', this).attr('address'));
    $('#supplier_phone').val($('option:selected', this).attr('phone'));
  });
</script>