...
<!--                <div class="form-group">
                ...
                <div class="col-md-4 col-xs-12 pull pull-left">
                  ...
                  <div class="col-sm-7">
                    <select class="form-control select_group" id="customer_id" name="customer_id">
                      <?php foreach ($customers as $k => $v): ?>
                        <option value="<?php echo $v['id'] ?>" <?php if($order_data['order']['customer_id'] == $v['id']) { echo "selected='selected'"; } ?> ><?php echo $v['name'] ?></option>
                      <?php endforeach ?>
                    </select>
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_address" name="customer_address" placeholder="Enter Customer Address" value="<?php echo $customer_detail['address'] ?>" autocomplete="off">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_phone" name="customer_phone" placeholder="Enter Customer Phone" value="<?php echo $customer_detail['phone'] ?>" autocomplete="off">
                    </div>
                  </div>
                </div>
                         ...
                         <td>
                          <select class="form-control select_group product" data-row-id="row_<?php echo $x; ?>" id="product_<?php echo $x; ?>" name="product[]" style="width:100%;" onchange="getProductData(<?php echo $x; ?>)" required>
                              ...
                              <?php foreach ($products as $k => $v): ?>
                                <option value="<?php echo $v['id'] ?>" price="<?php echo $v['price'] ?>" <?php if($val['product_id'] == $v['id']) { echo "selected='selected'"; } ?>><?php echo $v['name'] ?></option>
                              <?php endforeach ?>
                            </select>
                          </td>
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="gross_amount" name="gross_amount" value="<?php echo $order_data['order']['gross_amount'] ?>" autocomplete="off">
                  ...
                  <select class="form-control" id="payment_method" name="payment_method">
                    <option value="1" <?php if($order_data['order']['payment_method'] == 1) { echo "selected='selected'"; } ?>>Cash in hand</option>
                    <option value="2" <?php if($order_data['order']['payment_method'] == 2) { echo "selected='selected'"; } ?>>Bank Transfer</option>
                  </select>
                </div>
                 </div>
                 <div class="form-group">
                  ...
                  <select class="form-control" id="order_status" name="order_status">
                    <option value="1" <?php if($order_data['order']['order_status'] == 1) { echo "selected='selected'"; } ?>>Pending</option>
                    <option value="2" <?php if($order_data['order']['order_status'] == 2) { echo "selected='selected'"; } ?>>Debit</option>
                    <option value="3" <?php if($order_data['order']['order_status'] == 3) { echo "selected='selected'"; } ?>>Paid</option>
                  </select>
                </div>
                 </div>
