...
$this->data['customer_detail'] = $this->model_customers->getCustomerData($this->data['order_data']['order']['customer_id']);
	...
	public function printDiv($id)
	{
		...
		if($id) {
			...
			$company_info = $this->model_company->getCompanyData(1);
                        $customer_detail = $this->model_customers->getCustomerData($order_data['customer_id']);
